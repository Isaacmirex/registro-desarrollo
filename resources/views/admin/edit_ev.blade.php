...
@section('content')
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">{{ __('Edición del evento') }}</div>

          <div class="card-body">
            <form method="POST"
              action="{{ route('eventos.update', $evento->id) }}">
              @csrf
              @method('PUT')
              <div class="row mb-3">
                <label for="nombre"
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select" aria-label="Default select example"
                    ...
                    @foreach ($usuarios as $usuario)
                      <option @if ($usuario->id == $evento->usuario_id) selected @endif
                        value="{{ $usuario->id }}">
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select" aria-label="Default select example"
                    ...
                    @foreach ($laboratorios as $lab)
                      <option @if ($lab->id == $evento->laboratorio_id) selected @endif
                        value="{{ $lab->id }}">
                        {{ $lab->nombre }}</option>
                    @endforeach
                  </select>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <textarea id="detalle" name="detalle" rows="5" cols="46">{{ $evento->detalle }}
                  </textarea>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="hora_inicio" type="time" class="form-control"
                    value="{{ $evento->hora_inicio }}" name="hora_inicio"
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="hora_fin" type="time" class="form-control"
                    value="{{ $evento->hora_fin }}" name="hora_fin"
                    autocomplete="new-password">
                </div>
              </div>
